== Vert.x Discovery Backend - Couchbase
...
<dependency>
  ...
  <artifactId>vertx-service-discovery-backend-couchbase</artifactId>
...
----
compile 'io.vertx:vertx-service-discovery-backend-couchbase:3.3.2'
----
...
The configuration is the client configuration as well as `key` indicating in which _key_ on Couchbase
